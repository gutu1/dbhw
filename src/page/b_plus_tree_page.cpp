 ...
 */
bool BPlusTreePage::IsLeafPage() const { return page_type_ == IndexPageType::LEAF_PAGE; }//如果是叶子结点的页，就返回ture，否则false
bool BPlusTreePage::IsRootPage() const { return parent_page_id_ == INVALID_PAGE_ID; }//如果父节点的id是无效的，说明该节点就是根节点，返回为true,否则false
